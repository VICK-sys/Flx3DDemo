...
- `morph`, `morphRadius` — blend the model toward a sphere (0 = normal, 1 = full blob). Animating this up, swapping the model, and animating back down produces a melting transition between different models
